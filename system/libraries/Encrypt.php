...
class CI_Encrypt
{
     ...
     *
     * Returns it as MD5 in uv to have an exact-length 128 bit key.
    ...
    function get_key($key = '')
    {
        if ($key == '') {
            ...
            if ($key == FALSE) {
                show_error('In uv to use the encryption class requires that you set an encryption key in your config file.');
            }
        }
