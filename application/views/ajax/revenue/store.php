...
<table class="table table-bordered table-striped">
    ...
    <tr>
        <th></th>
        <th class="text-center">Tên nhà</th>
    ...
    <?php if (isset($_list_stores) && count($_list_stores)) :
        foreach ($_list_stores as $key => $item) :
            ...
            <tr>
                <td style="text-align: center;">
                    <i style="color: #478fca!important;" title="Chi tiết công việc"
                       ...
                       class="fa fa-plus-circle i-list-uv-<?php echo $item['store_id']?>">
                    </i>
                    <i style="color: #478fca!important;" title="Chi tiết công việc"
                       onclick="cms_show_list_order(<?php echo $item['store_id'];?>)"
                       class="fa fa-minus-circle i-hide i-list-uv-<?php echo $item['store_id']?>">
                    </i>
                </td>
            ...
            <tr class="tr-hide" id="tr-list-uv-<?php echo $item['store_id']?>">
                <td colspan="15">
                    <div class="tabbable">
