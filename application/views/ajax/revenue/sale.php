            ...
            <div class="report-box" style="border: 1px dotted #ddd; border-radius: 0">
                ...
                <div class="infobox-data">
                    ...
                    <span class="infobox-data-number text-center"
                          style="font-size: 14px; color: #555;">Tổng số tiền hiết khấu</span>
                </div>
            </div>
        </div>
        <div class="col-md-3 padd-right-0">
...
<table class="table table-bordered table-striped">
    ...
    <?php if (isset($_list_sales) && count($_list_sales)) :
        foreach ($_list_sales as $key => $item) :
            ...
            <tr>
                <td style="text-align: center;">
                    <i style="color: #478fca!important;" title="Chi tiết công việc"
                                                   ...
                                                   class="fa fa-plus-circle i-list-uv-<?php echo $item['sale_id']?>">

                    </i>
                    <i style="color: #478fca!important;" title="Chi tiết công việc"
                       onclick="cms_show_list_order(<?php echo $item['sale_id'];?>)"
                       class="fa fa-minus-circle i-hide i-list-uv-<?php echo $item['sale_id']?>">
                    </i>
                </td>
            ...
            <tr class="tr-hide" id="tr-list-uv-<?php echo $item['sale_id']?>">
                <td colspan="15">
                    <div class="tabbable">
