...
<table class="table table-bordered table-striped">
    ...
    <tbody>
    <?php if (isset($_list_customers) && count($_list_customers)) :
        foreach ($_list_customers as $key => $item) :
            ?>
            <tr>
                <td style="text-align: center;">
                    <i style="color: #478fca!important;" title="Chi tiết đơn hàng"
                                                   onclick="cms_show_list_order(<?php echo $item['customer_id'];?>)"
                                                   class="fa fa-plus-circle i-list-uv-<?php echo $item['customer_id']?>">

                    </i>
                    <i style="color: #478fca!important;" title="Chi tiết đơn hàng"
                       onclick="cms_show_list_order(<?php echo $item['customer_id'];?>)"
                       class="fa fa-minus-circle i-hide i-list-uv-<?php echo $item['customer_id']?>">
                    </i>
                </td>
            ...
            <tr class="tr-hide" id="tr-list-uv-<?php echo $item['customer_id']?>">
                <td colspan="15">
                    <div class="tabbable">
