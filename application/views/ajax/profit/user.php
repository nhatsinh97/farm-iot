                                ...
                                <table class="table table-striped table-bordered table-hover dataTable">
                                    ...
                                    foreach ($item['_list_orders'] as $uv) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"
                                                style="background: #fff;"><?php echo cms_encode_currency_format($uv['total_origin_price']); ?></td>
                                            <td class="text-center"
                                                style="background: #fff;"><?php echo cms_encode_currency_format($uv['total_money']-$uv['total_origin_price']); ?></td>
                                        </tr>
                                    <?php
                                    }
                                    ?>
