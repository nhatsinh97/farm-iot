<table class="table table-bordered table-striped">
    ...
    <tr>
        ...
        <th class="text-center" style="background-color: #fff;">Ảnh hư hỏng</th>
        <th class="text-center">Ảnh thay mới</th>
        <th></th>
    ...
    <?php if (isset($_list_orders) && count($_list_orders)) :
        foreach ($_list_orders as $key => $item) :
            ...
            <tr>
                ...
                <td class="text-center"><?php echo cms_getNamestatusbyID($item['payment_method']); ?></td>
...
<div class="alert alert-info summany-info clearfix" role="alert">
    <div class="sm-info pull-left padd-0">
        Tổng số công việc: <span><?php echo (isset($total_orders['quantity'])) ? $total_orders['quantity'] : 0; ?></span>
        Tổng chi phí:
