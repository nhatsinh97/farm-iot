                ...
                <div class="right-action text-right">
                    <div class="btn-groups">
                        ...
                        <button type="button" class="btn btn-danger"
                                onclick="cms_restore_product_deactivated_bydetail(<?php echo $_detail_product['ID']; ?>)"><i
            ...
            <div class="col-md-12">
                ...
                <div class="collapse" id="collapseproductinfo">
                    <div class="col-md-3 padd-0">
                        ...
                        <small>Hình ảnh và mô tả sản phẩm.</small>
                    </div>
                    <div class="col-md-9">
                        <div class="row">
                            <div class="col-md-12 padd-0">
                                <div class="jumbotron text-center" id="img_upload"
                                    ...
                                    <input style="font-size: 14px; margin-bottom: 5px; display: inline-block;"
                                    />
