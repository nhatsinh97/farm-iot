                    ...
                    <div class="right-action text-right">
                        <div class="btn-groups">
                            <button type="button" class="btn btn-primary" data-toggle="modal"
                                    data-target="#create-cust"><i class="fa fa-plus-circle"></i> Tạo khu vực
                            </button>
    ...
    <div>
        <ul class="nav nav-tabs tab-setting" role="tablist" style="padding-left: 20px;">
            <li role="presentation" onclick="tab_click_act('customer');" class="active"><a href="#cus"
                                                                                             ...
                                                                                             role="tab"
                                                                                             data-toggle="tab"><i
                        class="fa fa-user"></i> Khu vực sửa chữa</a></li>
                ...
                <div class="cus-body">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <th class="text-center">Lần cuối sửa chữa</th>
                    ...
                    <div class="alert alert-info summany-info clearfix" role="alert">
                        <div class="ajax-loadlist-total sm-info pull-left padd-0">Tổng công việc:
                            <span><b><?php echo (isset($_total_customer) && !empty($_total_customer)) ? $_total_customer : '0'; ?></b></span>
                             | Tổng chi phí: <span><b><?php echo (isset($_total_money) && !empty($_total_money)) ? cms_encode_currency_format($_total_money) : '0'; ?></b> đ</span> | <!-- Tổng nợ: <span><b><?php echo (isset($_total_debt) && !empty($_total_debt)) ? cms_encode_currency_format($_total_debt) : '0'; ?></b> đ</span> --></div>
