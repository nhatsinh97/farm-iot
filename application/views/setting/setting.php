        ...
        <div role="tabpanel" class="tab-pane active" id="user">
            ...
            <div class="cms-function-user-info">
                <table class="table table-hover table-bordered">
                    ...
                    <tr>
                        <td class="text-center">Thiết lập Thông tin
                        </td>
                        <td class="text-center"><i class="fa fa-check" style="color: green;"></i></td>
                ...
                <div class="notes-info">
                    ...
                    <p><span style="font-weight: bold;">[Admin]</span> mới được xem giá</p>
                    ...
                    <p><span style="font-weight: bold;">[Nhân viên]</span> chỉ được nhập công việc và
                          ...
                          <div class="panel-heading">
                              ...
                              <button class="btn btn-default btn-sm create-nv pull-right btn-in-panel blue" data-toggle="modal"
                               ...
                               <button type="button" style="margin-right: 5px;" class="btn btn-info btn-sm btn-in-panel pull-right"
                                        onclick="cms_savefunc()"><i class="fa fa-floppy-o"></i> Lưu
                               </button>
                            </div>
                           <div class="panel-body">
                               <div class="group-user">
                           ...
                           <div class="panel-footer clearfix">
                               <div class="btn-groups pull-right">
                                    <button type="button" class="btn btn-info btn-in-panel"  onclick="cms_savefunc()"><i
