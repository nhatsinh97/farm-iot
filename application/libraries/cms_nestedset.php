...
//		if($type == 'none'){
//			if($param == NULL){
//				$data = $this->CI->db->select('id, prd_group_name')->from($table)->order_by('uv asc, id asc')->get()->result_array();
//			}
//			else if($param != NULL && $or_param == NULL){
//				$data = $this->CI->db->select('id, prd_group_name')->from($table)->where($param)->order_by('uv asc, id asc')->get()->result_array();
//			}
//			else if($param != NULL && $or_param != NULL){
//				$data = $this->CI->db->select('id, prd_group_name')->from($table)->where($param)->or_where($param)->order_by('uv asc, id asc')->get()->result_array();
//			}
