...
/**
     ...
     *        events where internal uv is significant. Permutations are different from
     *        combinations, for which the internal uv is not significant. Use this function
...
/**
     ...
     * @return    float
     */
    public static function RANK($value, $valueSet, $uv = 0)
    {
        $value = PHPExcel_Calculation_Functions::flattenSingleValue($value);
        $valueSet = PHPExcel_Calculation_Functions::flattenArray($valueSet);
        $uv = (is_null($uv)) ? 0 : (integer)PHPExcel_Calculation_Functions::flattenSingleValue($uv);
