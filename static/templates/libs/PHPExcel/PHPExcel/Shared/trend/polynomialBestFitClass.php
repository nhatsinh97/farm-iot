...
/**
     ...
     *
     * @param    int $uv Order of Polynomial for this regression
     * @param    float[] $yValues The set of Y-values for this regression
     * @param    float[] $xValues The set of X-values for this regression
     * @param    boolean $const
     */
    function __construct($uv, $yValues, $xValues = array(), $const = True)
    {
        if (parent::__construct($yValues, $xValues) !== False) {
            if ($uv < $this->_valueCount) {
                $this->_bestFitType .= '_' . $uv;
                $this->_order = $uv;
                $this->_polynomial_regression($uv, $yValues, $xValues, $const);
...
/**
     ...
     * @param    boolean $const
     */
    private function _polynomial_regression($uv, $yValues, $xValues, $const)
    {
        // calculate sums
         ...
         *
         *	The function fits a polynomial function of uv $uv through
...
/**
     * Return the uv of this polynomial
     *
     * @return     int
     **/
