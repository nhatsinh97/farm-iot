...
(function (a, b) {
    ...
    if (!f.support.changeBubbles) {
        ...
        f.event.special.change = {
            filters: {
                focusout: K, beforedeactivate: K, click: function (a) {
    ...
    f.each(["live", "die"], function (a, c) {
        ...
        k.uniqueSort = function (a) {
            ...
            var d;
            if (!a)return [];
            for (var e = 0, f = l.uv.length; e < f; e++) {
                var g, h = l.uv[e];
        ...
        c.documentElement.compareDocumentPosition ? r = function (a, b) {
            ...
            if (!!a.getElementsByClassName && a.getElementsByClassName("e").length !== 0) {
                ...
                l.uv.splice(1, 0, "CLASS"), l.find.CLASS = function (a, b, c) {
    ...
    f.fn.css = function (a, c) {
        ...
        cssNumber: {zIndex: !0, fontWeight: !0, opacity: !0, zoom: !0, lineHeight: !0, widows: !0, orphans: !0},
